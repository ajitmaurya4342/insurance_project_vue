...
$color= $opening_balance_payment>0?"#006400":"#FF0000";
...
$books[] = [
  ...
  '<right><style color="#6fa8dc"><b>'. $opening_balance_payment . '</b></style></right>'
];
...
$color= $final_balance_payment>0?"#006400":"#FF0000";
$books[] = [
  null,
  ...
  '<right><style color="#6fa8dc"><b>'. $final_balance_payment . '</b></style></right>'
];
...
$extra_file_name = "";
if ($pm_id) {
 $extra_file_name = str_replace(".", "_", $getQueryData[0]["pm_name"]);
